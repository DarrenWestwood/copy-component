...
// Used to allow copying of code such as js script tags
...
var showCopiedText = function (copy_element) {
  ...
  copied_text.style.height = copy_input.querySelector("input")
    ? copy_input.querySelector("input").getBoundingClientRect().height + "px"
    : copy_input.querySelector("[data-copy]").offsetHeight + "px";
  copied_text.style.lineHeight = copy_input.querySelector("input")
    ? copy_input.querySelector("input").getBoundingClientRect().height + "px"
    : copy_input.querySelector("[data-copy]").offsetHeight + "px";
  // Show copied overlay
...
Is transformed into the correct structure:
<div class="output-copy-container">
  <div class="output-copy blockonomics-input">
    <input value="MyValue" data-copy>
    <span class="copied-text">Copied <img class="blockonomics-icon" src="/img/blockonomics_icons/confirm-circle.png"></span>
...
for (var i = el1.length - 1; i >= 0; i--) {
  ...
  const confirm_src =
    el1[i].getAttribute("light-icons") === null
      ? "img/blockonomics_icons/confirm-circle-dark.png"
      : "img/blockonomics_icons/confirm-circle.png";
  copied.innerHTML =
    'Copied <img class="blockonomics-icon" src="' + confirm_src + '">';
  ...
  const copy_src =
    el1[i].getAttribute("light-icons") === null
      ? "img/blockonomics_icons/copy-dark.png"
      : "img/blockonomics_icons/copy.png";
  image.setAttribute("src", copy_src);
